...
if (isset($_POST['Save']))
{
    ...
    if (!empty($id)){
        ...
        $sql_insert = "UPDATE `slider` SET `Path`='$Path',`Alt`='$Alt',`Title`='$Title' WHERE `id`='$id'";// $id не из базы, а то что содержиться в переменной post в поле, которое мы редактируем
