...
if (isset($_POST['Delete']))
{
    ...
    if (!empty($id)){
        ...
        $sql_insert = "DELETE FROM `reviews_form` WHERE `id`='$id'";// $id не из базы, а то что содержиться в переменной post в поле, которое мы редактируем
            ...
            <td style="padding-left: 30px;">
                ...
                <form action="edit_slider.php" method="post" enctype="multipart/form-data">
                    <table border="1" bordercolor="#e2e2e2" width="1470" height="100" cellpadding="0" cellspacing="0" style=" table-layout:fixed; float:left; margin:0 9px 0 0;">
                        <tr style="text-align: center; background-color: #9bd7d5; color: #fff; font-size: 20px;">
                            <td width="20px">id</td><td width="50px">Name</td><td width="70px">Surname</td><td width="60px">Date</td>
                            <td width="250px">What_like</td><td width="100px">Path</td><td width="50px"></td>
                        </tr>
                        <tr style="text-align: center; background-color: #9bd7d5; color: #fff; font-size: 20px;">
                            ...
                            <td><input name="Date" type="text" value="<?php echo $str['Date']; ?>" size="10"></td>
                            <td><input name="What_like" type="text" value="<?php echo $str['What_like']; ?>" size="45"></td>
                            <td><input name="Path" type="text" value="<?php echo $str['Path']; ?>" size="25"></td>
