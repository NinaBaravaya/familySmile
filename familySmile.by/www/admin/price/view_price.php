...
<table border="1" bgcolor="#e2e2e2" bordercolor="#e2e2e2" width="1200" height="600" cellpadding="0" cellspacing="0">
    ...
    <tr valign="top">
        <td style="padding-left: 30px;">
            ...
            <?php
            $SQL = "SELECT `id`, `Name`, `Price` FROM `price`";
            $data = mysql_query($SQL);
            $count = mysql_affected_rows();
            $inf .='<table border="1" bordercolor="#e2e2e2" width="1200" height="150px" cellpadding="0" cellspacing="0" style=" table-layout:fixed; float:left; margin:0 9px 0 0;">';
            $inf .='<tr style="text-align: center; background-color: #9bd7d5; color: #fff; font-size: 20px;">
                    <td width="50px">id</td><td width="500px">Name</td><td>Price</td><td></td><td></td></tr>';
            ...
            for($i=0;$i<$count;$i++)
            {
                ...
                $inf .='<td width="500px">' .$str['Name'].'</td>';
                $inf .='<td width="150px">' .$str['Price'].'</td>';


                $inf .= '<td><form action="edit_price.php" method="POST"><button type="submit" name="edit" value="'.$str['id'].'">Редактировать</button></form></td>



                    <td><form action="delete_price.php" method="POST"><button name="delete" type="submit" value="'.$str['id'].'">Удалить</button></form></td>';
            ...
            <form action="add_price.php" method="POST"><input style="margin: 30px 0 0 0" name="Slider" type="submit" value="добавить"></form>
        </td>
