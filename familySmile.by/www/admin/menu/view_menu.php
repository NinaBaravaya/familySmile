...
<table border="1" bgcolor="#e2e2e2" bordercolor="#e2e2e2" width="1150" height="400" cellpadding="0" cellspacing="0">
    ...
    <tr valign="top">
        <td style="padding-left: 30px;">
            ...
            <?php
            $SQL = "SELECT `id`, `title`, `link`, `parent_id` FROM `menu`";
            ...
            for($i=0;$i<$count;$i++)
            {
                ...
                $inf .='<td width="250px">' .$str['title'].'</td>';
                $inf .='<td width="150px">' .$str['link'].'</td>';
                $inf .='<td width="150px">' .$str['parent_id'].'</td>';

                $inf .= '<td><form action="edit_menu.php" method="POST"><button type="submit" name="edit" value="'.$str['id'].'">Редактировать</button></form></td>



                    <td><form action="delete_menu.php" method="POST"><button name="delete" type="submit" value="'.$str['id'].'">Удалить</button></form></td>';
            ...
            <form action="add_menu.php" method="POST"><input style="margin: 30px 0 0 0" name="Slider" type="submit" value="добавить"></form>
        </td>
