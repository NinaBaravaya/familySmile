...
if (isset($_POST['Delete']))
{
    ...
    if (!empty($id)){
        ...
        $sql_insert = "DELETE FROM `menu` WHERE `id`='$id'";// $id не из базы, а то что содержиться в переменной post в поле, которое мы редактируем
    ...
    <table border="1" bgcolor="#e2e2e2" bordercolor="#e2e2e2" width="1150" height="600" cellpadding="0" cellspacing="0">
        <tr valign="top">
            ...
            <td style="padding-left: 30px;">
                ...
                <form action="delete_menu.php" method="post" enctype="multipart/form-data">
