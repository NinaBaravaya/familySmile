        ...
        <section>
            <div class="first">
                ...
                <div class="text_goal">
                    <h2>цены</h2>
                    <p>заботиться о здоровьи зубов и полости рта вас и вашей семьи<br/>Мы подарим улыбку каждому!</p>
            ...
            <div class="second_price">
                ...
                <p> ***Стоимость услуг может изменяться и зависит от используемых материалов.</p>
            </div>
            <div class="attention_price">
                <p>
                    <strong>ВНИМАНИЕ!</strong> В клинике familySmile действует <a href="paid.php">гибкая система оплаты</a>.
                    Мы заботимся о вас.
